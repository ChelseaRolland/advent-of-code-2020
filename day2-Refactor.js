...
let passArr = ["1-14 b: bbbbbbbbbbbbbbbbbbb" ,
...
function reviewAllPassword(){
    ...
    passArr.forEach((pass, index) => {
        //getting each individual password line
        let arr = pass.split(" ");
        //getting the specific letter/character without the :
        let char = arr[1].substring(0,1);
        //getting the number requirement of min and max
        let numReq = arr[0].split("-");
        //pulling the actual min and max
        let min = numReq[0];
        let max = numReq[1];
        console.log("arr = ",arr);
